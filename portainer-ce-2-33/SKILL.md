---
name: portainer-ce-2-33
description: "Interact with the Portainer CE v2.33.7 REST API. Covers authentication, environments, stacks, containers, Docker proxy, Kubernetes resources, edge agents, registries, users/teams, and settings. Use when automating Portainer 2.33.x deployments or writing integration code against this version."
compatibility: "Requires network access to a Portainer CE 2.33.x instance. curl or an HTTP client must be available."
metadata:
  author: cbn
...
# Portainer CE v2.33.7 API

You are interacting with the **Portainer Community Edition v2.33.7** REST API. This skill provides the authentication flow, key concepts, endpoint categories, common operations, and gotchas specific to this version.
...
| GET | `/kubernetes/{id}/metrics/pods/{namespace}` | Pod metrics |
